  ...
  return (
    <html lang="en" className="!scroll-smooth">
      <head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600&family=Playfair+Display:wght@700&family=League+Spartan:wght@700&family=Poppins:wght@400;600&display=swap" rel="stylesheet" />
        <script
